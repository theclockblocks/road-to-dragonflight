...
.cxpop-inner {
  ...
  border-radius: 8px;
  box-shadow: 0 16px 44px rgba(0, 0, 0, 0.6), 0 2px 8px rgba(0, 0, 0, 0.4);
...
@media (max-width: 700px) {
  dialog.cxpop {
    ...
    margin: 0;
    width: 100%;
    /* padding is the gap between the card and the screen edges; the bottom
       gap is deliberately generous so a strip of the page shows beneath the
       card and it reads as floating over the text, not anchored to the frame */
